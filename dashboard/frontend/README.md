...
bounded session catalog and polls the selected state every five seconds. It
cancels timers and rejects stale responses when selection changes, while
retaining separate catalog and state errors.
