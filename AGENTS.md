...
- The durable-state restart, profile/session isolation, schema-version,
  ...
  contains the Phase 5 public-signature privacy documentation changes.
...
1. Review and commit the Phase 5 public-signature documentation slice when requested,
