...
- `a622597` (`test: guard adapter behavior without session identity`) is the current
...
- The durable-state restart, profile/session isolation, schema-version,
  ...
  The working tree contains the current Phase 1 SOUL-path fixture changes.
...
1. Review and commit the current Phase 1 SOUL-path fixture slice when
