...
- `412bec7` (`test: cover alternate Hermes callback aliases`) is the current
...
- The durable-state restart, profile/session isolation, schema-version,
  ...
  The working tree contains the current Phase 1 missing-session fixture changes.
...
1. Review and commit the current Phase 1 missing-session fixture slice when
