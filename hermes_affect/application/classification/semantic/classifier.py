"""Semantic classification contracts, validation, and arbitration policy."""
...
class SemanticClassifierConfig:
    ...
    def from_mapping(cls, raw: Any) -> tuple[SemanticClassifierConfig, list[str]]:
        ...
        if (
            ...
            warnings.append("Invalid semantic_classifier.min_confidence; using 0.85.")
        ...
        if (
            ...
            warnings.append("Invalid semantic_classifier.max_message_chars; using 1200 characters.")
        ...
        if (
            ...
            warnings.append("Invalid semantic_classifier.max_context_messages; using 2 messages.")
        ...
        if fallback not in {"ignore", "deterministic"}:
            warnings.append("Invalid semantic_classifier.fallback; using safe ignore behavior.")
...
def arbitrate_classifications(
    ...
    *,
    ...
    authoritative = [
        event for event in deterministic_events if event.event_type == EventType.USER_MODERATION
    ]
    if authoritative:
